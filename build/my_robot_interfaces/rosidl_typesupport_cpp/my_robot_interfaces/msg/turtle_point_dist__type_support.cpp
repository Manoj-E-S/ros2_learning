...
static const _TurtlePointDist_type_support_symbol_names_t _TurtlePointDist_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, msg, TurtlePointDist)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, msg, TurtlePointDist)),
  }
};
...
{
  return &::my_robot_interfaces::msg::rosidl_typesupport_cpp::TurtlePointDist_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_interfaces, msg, TurtlePointDist)() {
  return get_message_type_support_handle<my_robot_interfaces::msg::TurtlePointDist>();
}
