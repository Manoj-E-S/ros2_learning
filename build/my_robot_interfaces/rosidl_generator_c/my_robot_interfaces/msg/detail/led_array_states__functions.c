...
my_robot_interfaces__msg__LedArrayStates__init(my_robot_interfaces__msg__LedArrayStates * msg)
{
  ...
  // led_states
  if (!rosidl_runtime_c__boolean__Sequence__init(&msg->led_states, 0)) {
    my_robot_interfaces__msg__LedArrayStates__fini(msg);
    return false;
  }
  return true;
}
...
my_robot_interfaces__msg__LedArrayStates__fini(my_robot_interfaces__msg__LedArrayStates * msg)
{
  ...
  // led_states
  rosidl_runtime_c__boolean__Sequence__fini(&msg->led_states);
}
...
my_robot_interfaces__msg__LedArrayStates__create()
{
  ...
  my_robot_interfaces__msg__LedArrayStates * msg = (my_robot_interfaces__msg__LedArrayStates *)allocator.allocate(sizeof(my_robot_interfaces__msg__LedArrayStates), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_robot_interfaces__msg__LedArrayStates));
  bool success = my_robot_interfaces__msg__LedArrayStates__init(msg);
  if (!success) {
...
my_robot_interfaces__msg__LedArrayStates__Sequence__init(my_robot_interfaces__msg__LedArrayStates__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__msg__LedArrayStates * data = NULL;

  if (size) {
    data = (my_robot_interfaces__msg__LedArrayStates *)allocator.zero_allocate(size, sizeof(my_robot_interfaces__msg__LedArrayStates), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_robot_interfaces__msg__LedArrayStates__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_robot_interfaces__msg__LedArrayStates__fini(&data[i - 1]);
      }
...
my_robot_interfaces__msg__LedArrayStates__Sequence__fini(my_robot_interfaces__msg__LedArrayStates__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_robot_interfaces__msg__LedArrayStates__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__msg__LedArrayStates__Sequence * array = (my_robot_interfaces__msg__LedArrayStates__Sequence *)allocator.allocate(sizeof(my_robot_interfaces__msg__LedArrayStates__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_robot_interfaces__msg__LedArrayStates__Sequence__init(array, size);
  if (!success) {
...
my_robot_interfaces__msg__LedArrayStates__Sequence__destroy(my_robot_interfaces__msg__LedArrayStates__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_robot_interfaces__msg__LedArrayStates__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_robot_interfaces__msg__LedArrayStates__Sequence__are_equal(const my_robot_interfaces__msg__LedArrayStates__Sequence * lhs, const my_robot_interfaces__msg__LedArrayStates__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_robot_interfaces__msg__LedArrayStates__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_robot_interfaces__msg__LedArrayStates__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_robot_interfaces__msg__LedArrayStates);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_robot_interfaces__msg__LedArrayStates * data =
      (my_robot_interfaces__msg__LedArrayStates *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_robot_interfaces__msg__LedArrayStates__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_robot_interfaces__msg__LedArrayStates__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_robot_interfaces__msg__LedArrayStates__copy(
